...
//	@Test
	public void testSort() throws Exception {
		...
		assertEquals(38.4, 0.0, Algorithms.sortScores(results).get(0));
		assertEquals(40.7, 0.0, Algorithms.sortScores(results).get(1));
		assertEquals(95.0, 0.0, Algorithms.sortScores(results).get(13));
	}
